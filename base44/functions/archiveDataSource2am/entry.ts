...
Deno.serve(async (req) => {
  try {
    ...
    const existing = await base44.asServiceRole.entities.DataSource2amArchive.filter({ source_id: entityId });
    ...
    await base44.asServiceRole.entities.DataSource2amArchive.create(archiveEntry);
