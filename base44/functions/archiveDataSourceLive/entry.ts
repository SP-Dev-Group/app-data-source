...
Deno.serve(async (req) => {
  try {
    ...
    const existing = await base44.asServiceRole.entities.DataSourceLiveArchive.filter({ source_id: entityId });
    ...
    await base44.asServiceRole.entities.DataSourceLiveArchive.create(archiveEntry);
