...
export default function GoogleSheetsManualArchiveInstructions() {
        ...
        <div className="space-y-4 text-sm overflow-y-auto flex-1 pr-4">
          <div>
            ...
            <ol className="list-decimal ml-5 space-y-2">
              ...
              <li>The archive spreadsheet ID is: <code className="bg-muted px-1 rounded text-xs">1PtjThbFY89u7_z7fowTsfm-xDV03I4IqFuTN_h_G18w</code></li>
            </ol>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="list-disc ml-5 space-y-1 text-muted-foreground">
              ...
              <li>Click "Reinstate" on deleted records to restore them to the active sheet</li>
            </ul>
          </div>
        </div>
      </DialogContent>
