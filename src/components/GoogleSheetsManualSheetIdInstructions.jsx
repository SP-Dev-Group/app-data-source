        ...
        <div className="space-y-4 text-sm overflow-y-auto flex-1 pr-4">
          <div>
            ...
            <ol className="list-decimal ml-5 space-y-2">
              <li>Create a new Google Sheet with headers in the first row</li>
              <li>Required headers: <strong>Unique ID</strong> (column A), <strong>Name</strong> (column B)</li>
              <li>Base44 uses the top row as headers and skips it when loading data</li>
              <li>Form fields map to columns: Unique ID → Column A, Name → Column B</li>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-2">Every create, update, and delete is logged to a paired archive Google Sheet (<code className="bg-muted px-1 rounded text-xs">1Gxc4hxadg7XYfMv_NvD9O-rsfLx7kc-8a04YjXbsNdY</code>). The archive sheet has columns:</p>
