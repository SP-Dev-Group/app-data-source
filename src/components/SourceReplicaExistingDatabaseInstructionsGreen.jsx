        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="border rounded-lg p-3 space-y-3 bg-muted/20">
            ...
            <p className="text-xs bg-blue-50 border border-blue-200 rounded p-2 text-blue-800">
              <strong>Instruction:</strong> In this Replica app, create entity using the provided schema from Source App and name it <code className="bg-blue-100 px-1 rounded">{form.source_entity_name}</code>
            </p>
