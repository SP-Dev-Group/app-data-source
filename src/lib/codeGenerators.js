...
${formData.sourcePage?.mode === 'existing'
  ? `Use existing page: **${formData.sourcePage?.fileName || '⚠️ FILE NAME NOT SET — enter it in Page Configuration above'}**
  - Integrate the ${sourceEntityName} table and Replica Config panel into this existing page.`
  : `Create a new page: **${formData.sourcePage?.fileName || '⚠️ FILE NAME NOT SET — enter it in Page Configuration above'}**
...
${formData.replicaPage?.mode === 'existing'
  ? `Use existing page: **${formData.replicaPage?.fileName || '⚠️ FILE NAME NOT SET — enter it in Page Configuration above'}**
  - Integrate the ${replicaEntityName} read-only table into this existing page.`
  : `Create a new page: **${formData.replicaPage?.fileName || '⚠️ FILE NAME NOT SET — enter it in Page Configuration above'}**
