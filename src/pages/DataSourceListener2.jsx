  ...
  return (
    <div className="min-h-screen bg-background px-6 py-12 relative">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-sm font-light uppercase tracking-widest text-muted-foreground mb-1 text-center">Listener Data</p>
        <p className="text-xs font-mono text-muted-foreground mb-4 text-center">DataSourceListener2</p>
